...
@section('title', '| Admin | Create | AssistChaplain')

@section('content')

<div>
    <div class="">
      <a class="buttons" href="{{route('assistChaplain.index')}}">Back</a>
    </div>
       <h1>Add Assist. Chaplain</h1>
       
       <hr>

       <form method="POST" action="{{route('assistChaplain.store')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
