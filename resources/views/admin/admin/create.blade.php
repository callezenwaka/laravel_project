...
<div class="content top-margin">
	<div class="wrapper center">
       ...
       <hr>
        ...
        <form class="center" method="POST" action="{{route('admin.store')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
          ...
          <div class="row {{ $errors->has('image') ? 'has-error' : '' }}">
                    <div class="input1">
                        ...
                        <input id="image" type="file" class="input" name="image" value="{{ old('image') }}" placeholder="Image" autofocus>
                    </div>
                    <div class="col-md-6">
                        @if ($errors->has('image'))
                            <span class="help-block">
          ...
          <div class="row {{ $errors->has('phone') ? 'has-error' : '' }}">
            ...
            <div class="row {{ $errors->has('status') ? 'has-error' : '' }}">
                    <div class="input1">
                        ...
                        <div class="checkbox">
                            <label><input id="" type="checkbox" class="" name="status" @if (old('status') == 1) checked @endif value="1">Status</label>
                        </div>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="row">
                    <label for="role" class="">Assign Roles: </label>
